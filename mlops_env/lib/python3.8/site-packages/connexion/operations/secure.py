        ...
        for security_req in self.security:
            ...
            for scheme_name, required_scopes in security_req.items():
                ...
                if security_scheme["type"] == "oauth2":
                    ...
                    oauth = True
                    token_info_func = (
                        self._api.security_handler_factory.get_tokeninfo_func(
                            security_scheme
                        )
                    )
                    scope_validate_func = (
                        self._api.security_handler_factory.get_scope_validate_func(
                            security_scheme
                        )
                    )
                ...
                # OpenAPI 3.0.0
                    ...
                    if scheme == "basic":
                        ...
                        bearer_info_func = (
                            self._api.security_handler_factory.get_bearerinfo_func(
                                security_scheme
                            )
                        )
                    ...
                    if scheme == "bearer":
                        ...
                        apikey_info_func = (
                            self._api.security_handler_factory.get_apikeyinfo_func(
                                security_scheme
                            )
                        )
                ...
                if len(sec_req_funcs) == 1:
                    ...
                    auth_funcs.append(
                        self._api.security_handler_factory.verify_multiple_schemes(
                            sec_req_funcs
                        )
                    )

        return functools.partial(
            self._api.security_handler_factory.verify_security, auth_funcs
        )
