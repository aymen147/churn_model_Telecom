...
class WorkspaceClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._account_access_control_proxy = AccountAccessControlProxyAPI(
            self._api_client
        )
        ...
        self._provider_personalization_requests = ProviderPersonalizationRequestsAPI(
            self._api_client
        )
        self._provider_provider_analytics_dashboards = (
            ProviderProviderAnalyticsDashboardsAPI(self._api_client)
        )
        ...
        self._query_visualizations_legacy = QueryVisualizationsLegacyAPI(
            self._api_client
        )
        ...
        self._temporary_table_credentials = TemporaryTableCredentialsAPI(
            self._api_client
        )
