...
class CleanRoom:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoom:
        ...
        return cls(
            ...
            remote_detailed_info=_from_dict(
                d, "remote_detailed_info", CleanRoomRemoteDetail
            ),
    ...
    **asset_type** is **VOLUME**"""
    ...
    def as_dict(self) -> dict:
        ...
        if self.foreign_table_local_details:
            body["foreign_table_local_details"] = (
                self.foreign_table_local_details.as_dict()
            )
        if self.name is not None:
            body["name"] = self.name
        if self.notebook:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomAsset:
        ...
        return cls(
            ...
            table_local_details=_from_dict(
                d, "table_local_details", CleanRoomAssetTableLocalDetails
            ),
            view=_from_dict(d, "view", CleanRoomAssetView),
            view_local_details=_from_dict(
                d, "view_local_details", CleanRoomAssetViewLocalDetails
            ),
            volume_local_details=_from_dict(
                d, "volume_local_details", CleanRoomAssetVolumeLocalDetails
            ),
        )
...
class CleanRoomAssetNotebook:
    ...
    def as_dict(self) -> dict:
        ...
        if self.runner_collaborators:
            body["runner_collaborators"] = [
                v.as_dict() for v in self.runner_collaborators
            ]
        return body
    ...
    def as_shallow_dict(self) -> dict:
        ...
        if self.runner_collaborators:
            body["runner_collaborators"] = self.runner_collaborators
        return body
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomAssetNotebook:
        ...
        return cls(
            ...
            review_state=_enum(
                d, "review_state", CleanRoomNotebookReviewNotebookReviewState
            ),
            reviews=_repeated_dict(d, "reviews", CleanRoomNotebookReview),
            runner_collaborators=_repeated_dict(
                d, "runner_collaborators", CleanRoomCollaborator
            ),
        )
    ...
    *catalog*.*schema*.*table_name*"""
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomAssetTableLocalDetails:
        ...
        return cls(
            ...
            partitions=_repeated_dict(
                d, "partitions", sharing.PartitionSpecificationPartition
            ),
        )
...
class CleanRoomNotebookTaskRun:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomNotebookTaskRun:
        ...
        return cls(
            collaborator_job_run_info=_from_dict(
                d, "collaborator_job_run_info", CollaboratorJobRunInfo
            ),
            notebook_job_run_state=_from_dict(
                d, "notebook_job_run_state", jobs.CleanRoomTaskRunState
            ),
...
class CleanRoomRemoteDetail:
    ...
    def as_dict(self) -> dict:
        ...
        if self.compliance_security_profile:
            body["compliance_security_profile"] = (
                self.compliance_security_profile.as_dict()
            )
        if self.creator:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomRemoteDetail:
        ...
        return cls(
            ...
            compliance_security_profile=_from_dict(
                d, "compliance_security_profile", ComplianceSecurityProfile
            ),
            creator=_from_dict(d, "creator", CleanRoomCollaborator),
            egress_network_policy=_from_dict(
                d, "egress_network_policy", settings.EgressNetworkPolicy
            ),
...
class ComplianceSecurityProfile:
    ...
    def as_dict(self) -> dict:
        ...
        if self.compliance_standards:
            body["compliance_standards"] = [
                v.as_dict() for v in self.compliance_standards
            ]
    ...
    def from_dict(cls, d: Dict[str, any]) -> ComplianceSecurityProfile:
        ...
        return cls(
            compliance_standards=_repeated_dict(
                d, "compliance_standards", settings.ComplianceStandard
            ),
...
class UpdateCleanRoomRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> UpdateCleanRoomRequest:
        ...
        return cls(
            clean_room=_from_dict(d, "clean_room", CleanRoom), name=d.get("name", None)
        )
...
class CleanRoomAssetsAPI:
    ...
    def create(
        self, clean_room_name: str, *, asset: Optional[CleanRoomAsset] = None
    ) -> CleanRoomAsset:
        """Create an asset.
    ...
    def list(
        self, clean_room_name: str, *, page_token: Optional[str] = None
...
class CleanRoomsAPI:
    ...
    def list(
        ...
        while True:
            json = self._api.do(
                "GET", "/api/2.0/clean-rooms", query=query, headers=headers
            )
    ...
    def update(self, name: str, *, clean_room: Optional[CleanRoom] = None) -> CleanRoom:
        ...
        res = self._api.do(
            "PATCH", f"/api/2.0/clean-rooms/{name}", body=body, headers=headers
        )
        return CleanRoom.from_dict(res)
