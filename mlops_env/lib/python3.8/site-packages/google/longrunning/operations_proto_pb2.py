...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _OPERATIONS.methods_by_name["ListOperations"]._serialized_options = (
    ...
    _OPERATIONS.methods_by_name["GetOperation"]._serialized_options = (
    ...
    _OPERATIONS.methods_by_name["DeleteOperation"]._serialized_options = (
        b"\332A\004name\202\323\344\223\002\032*\030/v1/{name=operations/**}"
    )
    _OPERATIONS.methods_by_name["CancelOperation"]._options = None
    _OPERATIONS.methods_by_name["CancelOperation"]._serialized_options = (
