...
class ExecutorLoader:
            ...
            with suppress(ImportError, AttributeError):
                ...
                return (
                    _import_and_validate(
                        f"airflow.executors.{executor_name.module_path}"
                    ),
                    ConnectorSource.PLUGIN,
                )
        return (
            _import_and_validate(executor_name.module_path),
    ...
    def validate_database_executor_compatibility(
        ...
        if (
            os.environ.get("_AIRFLOW__SKIP_DATABASE_EXECUTOR_COMPATIBILITY_CHECK")
            == "1"
        ):
            return
