...
class AirflowConfigParser(ConfigParser):
    ...
    deprecated_sections: dict[str, tuple[str, str]] = {
        "kubernetes_executor": ("kubernetes", "2.5.0")
    }
    ...
    def _upgrade_auth_backends(self):
        ...
        if old_value in ("airflow.api.auth.backend.default", ""):
            ...
            self._update_env_var(
                section="api", name="auth_backends", new_value=new_value
            )
    ...
    def get(  # type: ignore[override,misc]
        ...
        **kwargs,
        ...
        option_description = self.configuration_description.get(section, {}).get(
            key, {}
        )
